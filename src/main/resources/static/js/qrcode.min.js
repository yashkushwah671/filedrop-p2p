/**
 * QRCode.js v1.0.0 (Custom Standalone Lightweight Client-side QR Library)
 * Generates clean QR codes directly to HTML5 Canvas / DOM.
 */
(function (root, factory) {
    ...
    QRPolynomial.prototype = {
        ...
        multiply: function (e) {
            ...
            for (var i = 0; i < this.getLength() + e.getLength() - 1; i++) num[i] = 0;
    ...
    QRCode.prototype.render = function () {
        ...
        var nRowWidth = nWidth / nCount;
        var nRowHeight = nHeight / nCount;
        ...
        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                if (this._oQRCode.isDark(row, col)) {
                    var nLeft = Math.round(col * nRowWidth);
                    var nTop = Math.round(row * nRowHeight);
                    var nW = Math.ceil((col + 1) * nRowWidth) - nLeft;
                    var nH = Math.ceil((row + 1) * nRowHeight) - nTop;
                    ctx.fillRect(nLeft, nTop, nW, nH);
                }
            }
        }
